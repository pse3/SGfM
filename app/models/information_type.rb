# An InformationType is like an attribute. ActorType objects reference InformationType objects to declare which Information objects an Actor of an ActorType must have.
...
class InformationType
  ...
  field :key, :type => Symbol
	...
	belongs_to :information_field_type, :class_name => 'InformationFieldType', :inverse_of => nil  #referenced / one-way
