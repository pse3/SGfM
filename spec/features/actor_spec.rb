...
describe "actor spec" do
  ...
  before do
    ...
    scope_stats.name_translations = { :en => 'private and statistics', :de => 'privat and statistik', :it => 'privato and statistiche', :fr => 'prive and statistique' }
